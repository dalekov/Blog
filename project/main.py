...
# Custom decorator to protect URLs.
def admin_only(f):
    @wraps(f)
...
# Retrieve a user from the database based on their email and log them in
...
def contact():
    if request.method == "POST":
        ...
        with smtplib.SMTP('smtp.gmail.com', 587) as connection:
            connection.starttls()  # Encrypts email if the connection is interrupted
            connection.login(user="denisalekov17@gmail.com", password="bfrr cwou ugoy kvab")  # Log in to your account

            # Send email:
            connection.sendmail(from_addr="denisalekov17@gmail.com",
                                to_addrs="denis.alekov1@gmail.com",
